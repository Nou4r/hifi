...
<div class="grid w-full max-w-sm gap-4">
	...
	<div
		class="flex items-center text-sm text-zinc-400 before:me-6 before:flex-1 before:border-t before:border-zinc-600 after:ms-6 after:flex-1 after:border-t after:border-zinc-600 dark:text-white dark:before:border-neutral-600 dark:after:border-neutral-600"
	>
		Supported Apps
	</div>
