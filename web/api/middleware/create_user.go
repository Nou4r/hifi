...
func SignupUser(w http.ResponseWriter, r *http.Request) {
	...
	createCh := startCreateUser(ctx, client, base+"/admin/create_user_do", req.Username, req.Password, startLogin(ctx, client, base+"/admin/login_do", config.ProxyUser, config.ProxyKey))
